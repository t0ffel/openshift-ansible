  ...
  [
    ...
    parameters(
      [
        ...
        string(defaultValue: 'dh-prod-storage', description: 'OpenShift Project to deploy Elasticsearch into', name: 'ELASTICSEARCH_PROJECT'),
      ]
    ),
    pipelineTriggers([])
  ]
...
generated_certs_dir=$WORKSPACE/dh-ci-util/certificates/prod-es-certs/
"  playbooks/upshift-prod-es.yaml
