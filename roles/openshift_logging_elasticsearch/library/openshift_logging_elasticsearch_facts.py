...
class OpenshiftESFacts(OCBaseCommand):
    ...
    def __init__(self, logger, binary, kubeconfig, namespace, cluster_name, oc_username):
        ...
        ''' The init method for OpenshiftESFacts '''

        super(OpenshiftESFacts, self).__init__(binary, kubeconfig, namespace, oc_username)
        self.logger = logger
...
#            self.facts[comp] = dict()
    ...
    @staticmethod
    def populate_es_container_spec(pod_spec):
    ...
    def facts_for_ex_node_topology(self, namespace, es_role):
        ...
        for dc_item in dcs:
            ...
            node_facts = OpenshiftESFacts.populate_es_container_spec(spec)
...
def main():
    ...
    try:
        cmd = OpenshiftESFacts(module, module.params['oc_bin'],
